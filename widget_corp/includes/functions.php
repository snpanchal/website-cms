<?php
	...
	function password_encrypt($password) {
		$hash_format = "$2y$10$"; // use Blowfish algorithm with "cost" of 10
		$salt_length = 22; // Blowfish salts should be >= 22 characters
	...
	function generate_salt($length) {
		// Not 100% unique or random, but good enough for salts
